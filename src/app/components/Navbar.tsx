...
const Navbar = () => {
  ...
  return (
    ...
    <div className="relative shadow-sm border-b border-gray-200">
        ...
        <div className="h-full flex items-center justify-between md:hidden">
          ...
          <Link href="/">
            <div className="flex items-center justify-center cursor-pointer">
              <Image src="/logo-verde-manzana-gris.svg" alt="Logo" width={80} height={90} priority/>
            </div>
          </Link>
        ...
        <div className="hidden md:flex items-center justify-between h-full">
          ...
          <div className="w-1/3 flex items-center justify-center">
            <Link href="/">
              ...
              >
                <Image src="/logo-verde-manzana-gris.svg" alt="Logo" width={80} height={80} priority/>
              </div>
            </Link>
          </div>
          {/* RIGHT */}
      ...
      {isLargeScreen && (
        <div className="flex mt-4 mb-4 justify-center divide-x divide-gray-200 rounded-xl text-sm">
          ...
          <div className="px-10 cursor-pointer">
            <Link href="/reviews">Clientes Felices</Link>
          </div>
          <div className="px-10 cursor-pointer">
